...
*
****************************************************************************/
unsigned int CShellPidl::GetSize(LPCITEMIDLIST pidl)
{
...
/****************************************************************************
*
*    FUNCTION: CreatePidl(unsigned int cbSize)
*
*    PURPOSE:  Allocates a PIDL 
*
****************************************************************************/
LPITEMIDLIST CShellPidl::CreatePidl(unsigned int cbSize)
{
    LPMALLOC lpMalloc;
    HRESULT  hr;
...
/****************************************************************************
*
*    FUNCTION: GetIcon(LPITEMIDLIST lpi, unsigned int uFlags)
*
...
****************************************************************************/
int CShellPidl::GetItemIcon(LPITEMIDLIST lpi, unsigned int uFlags)
{
   SHFILEINFO    sfi;
